...
from tools.config_loader import get_wiki_page_config, get_wiki_content_config
...
WIKI_PAGE_CONTAINERS = get_wiki_page_config()
WIKI_CONTENT_CONFIG = get_wiki_content_config()
